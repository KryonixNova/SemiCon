    ...
    for batch in train_loader:
        ...
        if step % args.val_every == 0 or step == stop_step:
            ...
            if collapsed and os.path.exists(last_path):
                ...
                print(f"  WARNING: validation collapsed (nan predictions) but no prior "
                      f"checkpoint exists to roll back to -- continuing training as-is; "
                      f"if this doesn't self-correct, stop and investigate.")
            else:
